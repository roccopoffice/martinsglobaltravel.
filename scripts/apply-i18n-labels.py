...
REPLACEMENTS = [
    ...
    ('<p class="td-card-region">Europe</p>\n              <h3 class="td-card-title" data-i18n="home.tdPortugalTitle">Portugal</h3>',
     '<p class="td-card-region" data-i18n="home.tdPortugalRegion">Europe</p>\n              <h3 class="td-card-title" data-i18n="home.tdPortugalTitle">Portugal</h3>'),
    ...
    ('<p class="td-card-region">Europe</p>\n              <h3 class="td-card-title" data-i18n="home.tdSpainTitle">Spain</h3>',
     '<p class="td-card-region" data-i18n="home.tdSpainRegion">Europe</p>\n              <h3 class="td-card-title" data-i18n="home.tdSpainTitle">Spain</h3>'),
    ...
    # Marquee (all duplicate mq-items)
    ('<div class="mq-item">Italy<span', '<div class="mq-item"><span data-i18n="home.mqItaly">Italy</span><span'),
    ('<div class="mq-item">China<span', '<div class="mq-item"><span data-i18n="home.mqChina">China</span><span'),
    ('<div class="mq-item">Portugal<span', '<div class="mq-item"><span data-i18n="home.mqPortugal">Portugal</span><span'),
    ('<div class="mq-item">Spain<span', '<div class="mq-item"><span data-i18n="home.mqSpain">Spain</span><span'),
    ('<div class="mq-item">South Africa<span', '<div class="mq-item"><span data-i18n="home.mqSa">South Africa</span><span'),
    # About strip
    ...
    # Tour cards (6 featured journeys)
    ('data-local="assets/photos/tour-01"><div class="tcard-cat">Beach &amp; Luxury</div><div class="tcard-days">10 Days</div>',
     'data-local="assets/photos/tour-01"><div class="tcard-cat" data-i18n="home.tour1Cat">Beach &amp; Luxury</div><div class="tcard-days" data-i18n="home.tour1Days">10 Days</div>'),
    ('</svg>Maldives, Indian Ocean</div><div class="tcard-name">Maldives Overwater Escape</div><p class="tcard-desc">Private overwater villas, coral reef diving, and sunset cruises in the most pristine waters on earth.</p>',
     '</svg><span data-i18n="home.tour1Loc">Maldives, Indian Ocean</span></div><div class="tcard-name" data-i18n="home.tour1Name">Maldives Overwater Escape</div><p class="tcard-desc" data-i18n="home.tour1Desc">Private overwater villas, coral reef diving, and sunset cruises in the most pristine waters on earth.</p>'),
    ('data-local="assets/photos/tour-02"><div class="tcard-cat">Safari</div><div class="tcard-days">14 Days</div>',
     'data-local="assets/photos/tour-02"><div class="tcard-cat" data-i18n="home.tour2Cat">Safari</div><div class="tcard-days" data-i18n="home.tour2Days">14 Days</div>'),
    ('</svg>Tanzania, East Africa</div><div class="tcard-name">Great Migration Safari</div><p class="tcard-desc">Witness 1.5 million wildebeest cross the Serengeti — one of nature\'s greatest spectacles.</p>',
     '</svg><span data-i18n="home.tour2Loc">Tanzania, East Africa</span></div><div class="tcard-name" data-i18n="home.tour2Name">Great Migration Safari</div><p class="tcard-desc" data-i18n="home.tour2Desc">Witness 1.5 million wildebeest cross the Serengeti — one of nature\'s greatest spectacles.</p>'),
    ('data-local="assets/photos/tour-03"><div class="tcard-cat">Cultural</div><div class="tcard-days">12 Days</div>',
     'data-local="assets/photos/tour-03"><div class="tcard-cat" data-i18n="home.tour3Cat">Cultural</div><div class="tcard-days" data-i18n="home.tour3Days">12 Days</div>'),
    ('</svg>Japan, East Asia</div><div class="tcard-name">Japan Cherry Blossom</div><p class="tcard-desc">Tokyo, Kyoto, and Osaka during sakura season — an unforgettable cultural immersion.</p>',
     '</svg><span data-i18n="home.tour3Loc">Japan, East Asia</span></div><div class="tcard-name" data-i18n="home.tour3Name">Japan Cherry Blossom</div><p class="tcard-desc" data-i18n="home.tour3Desc">Tokyo, Kyoto, and Osaka during sakura season — an unforgettable cultural immersion.</p>'),
    ('data-local="assets/photos/tour-04"><div class="tcard-cat">Luxury</div><div class="tcard-days">8 Days</div>',
     'data-local="assets/photos/tour-04"><div class="tcard-cat" data-i18n="home.tour4Cat">Luxury</div><div class="tcard-days" data-i18n="home.tour4Days">8 Days</div>'),
    ('</svg>Greece, Mediterranean</div><div class="tcard-name">Greek Islands Yacht Charter</div><p class="tcard-desc">Private yacht hopping across Santorini, Mykonos, and Crete with your personal crew.</p>',
     '</svg><span data-i18n="home.tour4Loc">Greece, Mediterranean</span></div><div class="tcard-name" data-i18n="home.tour4Name">Greek Islands Yacht Charter</div><p class="tcard-desc" data-i18n="home.tour4Desc">Private yacht hopping across Santorini, Mykonos, and Crete with your personal crew.</p>'),
    ('data-local="assets/photos/tour-05"><div class="tcard-cat">Adventure</div><div class="tcard-days">9 Days</div>',
     'data-local="assets/photos/tour-05"><div class="tcard-cat" data-i18n="home.tour5Cat">Adventure</div><div class="tcard-days" data-i18n="home.tour5Days">9 Days</div>'),
    ('</svg>Iceland, North Atlantic</div><div class="tcard-name">Northern Lights Iceland</div><p class="tcard-desc">Chase the aurora borealis and soak in geothermal pools under a painted sky.</p>',
     '</svg><span data-i18n="home.tour5Loc">Iceland, North Atlantic</span></div><div class="tcard-name" data-i18n="home.tour5Name">Northern Lights Iceland</div><p class="tcard-desc" data-i18n="home.tour5Desc">Chase the aurora borealis and soak in geothermal pools under a painted sky.</p>'),
    ('data-local="assets/photos/tour-06"><div class="tcard-cat">Adventure</div><div class="tcard-days">16 Days</div>',
     'data-local="assets/photos/tour-06"><div class="tcard-cat" data-i18n="home.tour6Cat">Adventure</div><div class="tcard-days" data-i18n="home.tour6Days">16 Days</div>'),
    ('</svg>Patagonia, South America</div><div class="tcard-name">Patagonia Wilderness Trek</div><p class="tcard-desc">Glacier trekking, condor sightings, and end-of-the-world fjords across Argentina and Chile.</p>',
     '</svg><span data-i18n="home.tour6Loc">Patagonia, South America</span></div><div class="tcard-name" data-i18n="home.tour6Name">Patagonia Wilderness Trek</div><p class="tcard-desc" data-i18n="home.tour6Desc">Glacier trekking, condor sightings, and end-of-the-world fjords across Argentina and Chile.</p>'),
    # Why section
