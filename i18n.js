/**
 * Martins Global Travels — i18n engine.
 *
 * Reads window.MGT_TRANSLATIONS (defined in i18n/translations.js, which
 ...
 * localStorage under "mgt_lang" and keeps document.documentElement.lang
 * in sync.
 *
...
(function () {
  ...
  var STORAGE_KEY = "mgt_lang";
  var DEFAULT_LANG = "en";
  var SUPPORTED = ["en", "es", "pt", "ht", "kea", "fr", "zh"];

  function getDict() {
    return window.MGT_TRANSLATIONS || {};
  }
